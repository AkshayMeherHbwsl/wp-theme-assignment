...
<head>
	...
	<!-- <script type="text/javascript"
		src="http://localhost/wordpress/wp-content/themes/wp-theme/portfolio-pagination.js"></script> -->
	<script type="text/javascript"
		src="/home/akshay/Local Sites/practice/app/public/wp-content/themes/wp-theme/portfolio-pagination.js"></script>
...
<body <?php body_class(); ?>>
	...
	<div id=" page" class="site">
		<a class="skip-link screen-reader-text" href="#primary">
			<?php esc_html_e('Skip to content', 'wp-theme'); ?>
		</a>
		...
		<header id="masthead" class="site-header">
			...
			<nav id="site-navigation" class="main-navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
					<?php esc_html_e('Primary Menu', 'wp-theme'); ?>
				</button>
				<?php
				wp_nav_menu(
					array(
